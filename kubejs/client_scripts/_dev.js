if (false) {
    onEvent('item.right_click', (event) => {
        ...
        if (
            ...
            player.tell(Item.of('abnormals_delight:duck_fillet').withName('magic').nbt.prettyDisplay);
            player.tell(Text.of(Item.of('abnormals_delight:duck_fillet').nbt));
            player.tell(
                Item.of('abnormals_delight:duck_fillet').withNBT({
                    magic: true,
